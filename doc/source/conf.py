...
# -*- coding: utf-8 -*-
#
# tempvars documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'tempvars.tex', 'tempvars Documentation',
     'Brian Skinn', 'manual'),
]
...
man_pages = [
    (master_doc, 'tempvars', 'tempvars Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tempvars', 'tempvars Documentation',
     author, 'tempvars', 'One line description of project.',
     'Miscellaneous'),
]
